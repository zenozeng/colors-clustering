...
},{"./clustering.coffee":5}],5:[function(require,module,exports){
...
calcClusters = function(pixels, config) {
  ...
  iter = function() {
    ...
    return centers = clusters.map(function(clusterPixels) {
...
},{"./CIE67.coffee":3,"./seeds.coffee":6,"color-convert":2}],6:[function(require,module,exports){
var seeds;
